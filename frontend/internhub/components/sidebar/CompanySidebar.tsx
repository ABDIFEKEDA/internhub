...
import { LayoutDashboard, Users, FileText, Menu, X, UserCheck } from "lucide-react"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-blue-200 bg-blue-50/50">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-blue-800 truncate">Company Admin</p>
              <p className="text-xs text-blue-600 truncate">admin@company.com</p>
            </div>
          </div>
        </div>
      </aside>
