                ...
                <div className="overflow-y-auto flex-1 px-8 py-5 space-y-5">
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      { icon: Calendar, label: "Submitted", value: formatDate(selectedApp.updatedAt || "") },
                      ...
                      <div key={label} className="bg-orange-50/50 p-4 rounded-xl border border-orange-100">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            {href ? (
                              <a href={href} className="text-sm font-semibold text-gray-800 hover:text-orange-600">
                                {value}
                              </a>
                            ) : (
                  ...
                  <div className="bg-white rounded-xl border p-5">
                    <h3 className="font-semibold flex items-center gap-2 mb-4">
                      <GraduationCap className="h-4 w-4 text-orange-600" />Academic
                    </h3>
                  ...
                  {(selectedApp.github || selectedApp.linkedin) && (
                    <div className="bg-white rounded-xl border p-5">
                      {/* <h3 className="font-semibold flex items-center gap-2 mb-4">
                        <UserCircle className="h-4 w-4 text-orange-600" />Profiles
                      </h3> */}
                      <div className="flex gap-3">
                        {selectedApp.github && (
                          <a 
                      ...
                      {selectedApp.cv && (
                        <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-5 rounded-xl border-2 border-orange-200">
                          ...
                          <Button 
                            ...
                            className="w-full mt-2 bg-white border-2 border-orange-200 text-orange-700 hover:bg-orange-600 hover:text-white"
                          >
